...
if increase:
    start_entered = st.number_input("Enter start number: ")
    final_entered = st.number_input("Enter final number: ")
...
if decrease:
    start_entered1 = st.number_input("Enter start number: ")
    final_entered1 = st.number_input("Enter final number: ")
    def calc(pStart, pFinal):
